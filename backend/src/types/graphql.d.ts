...
export interface GetFrequencyLevelsResponse {
  ok: boolean;
  error: string | null;
  frequency: LevelOption | null;
}
...
export interface GetFrequencyLevelsqueryArgs {
  projectId: number;
}
